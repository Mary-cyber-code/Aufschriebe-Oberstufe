...
```html
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .flashcard-back .highlight { color: var(--gold); }
        ...
        .flashcard { perspective: 1000px; width: 200px; height: 240px; cursor: pointer; flex: 1 1 200px; }
        ...
        .flashcard-back { transform: rotateY(180deg); background-color: var(--forest); color: var(--paper-white); border-color: var(--forest); font-size: 0.9rem; }
        ...
        body.print-mode .page {
            width: 210mm; height: auto; min-height: 297mm; padding: 15mm; margin: 0 auto 20mm auto; background: white;
            box-shadow: 0 0 15px rgba(0,0,0,0.1); display: flex; flex-direction: column; overflow: visible; break-after: page;
        }
        ...
        @media (max-width: 768px) {
            ...
            .nav-group { gap: 8px; flex-wrap: wrap; justify-content: center; }
        ...
        @media print {
            ...
            .page { margin: 0; box-shadow: none; width: auto; height: auto !important; min-height: 297mm; padding: 15mm !important; display: flex; flex-direction: column; overflow: visible !important; break-after: page; }
